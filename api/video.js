...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Kling only accepts 5 or 10 - snap to the nearest valid value.
    ...
    if (klingKey) {
      try {
        ...
        const payload = hasImage
          ? { model_name: "kling-v1-6", image: imageBase64, prompt: prompt || "", duration: String(seconds), mode: "std", aspect_ratio: "16:9" }
          : { model_name: "kling-v1-6", prompt: prompt, negative_prompt: "", duration: String(seconds), mode: "std", aspect_ratio: "16:9", sound: "on" };
