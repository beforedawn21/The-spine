    ...
    if (klingKey) {
      try {
        ...
        const payload = hasImage
          ? { image: imageBase64, prompt: prompt || "", duration: String(seconds), mode: "std", audio: true, sound: true }
          : { prompt: prompt, duration: String(seconds), mode: "std", audio: true, sound: true };
