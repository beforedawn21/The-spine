...
export default function App(){
  ...
  function buildGameDoc(rawText,gameMode){
    ...
    return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
      ...
      +'</head><body>'+bodyInner
      +'<scr'+'ipt>window.addEventListener("load",function(){try{\n'+inlineJs+'\n}catch(e){document.body.innerHTML="<div style=\\"color:#fff;font-family:sans-serif;padding:20px\\">Game error: "+e.message+"</div>";}});</scr'+'ipt>'
      +'</body></html>';
  }
  function previewWeb(){
    let doc;
