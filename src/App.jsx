...
.starters{display:flex;flex-direction:column;gap:7px;max-width:360px;margin:12px auto 0;}
.starter{font:400 13px 'Inter';color:var(--ink2);background:var(--panel);border:1px solid var(--stone);border-radius:12px;padding:10px 14px;cursor:pointer;text-align:left;transition:all .12s;}
.starter:hover{border-color:var(--gold);color:var(--ink);}
.qa-chips{display:flex;gap:7px;flex-wrap:wrap;justify-content:center;max-width:360px;margin:12px auto 0;}
.qa-chip{background:var(--gold-s,#F4EDE0);border:1px solid var(--gold);border-radius:16px;padding:6px 14px;font:600 12px 'Inter';color:var(--gold);cursor:pointer;transition:all .12s;}
...
.greet{padding:14px 4px 6px;text-align:center;}
.greet-cord{width:3px;height:22px;margin:0 auto 8px;background:linear-gradient(var(--gold),transparent);border-radius:2px;}
.greet-h{font-size:21px;color:var(--ink);margin-bottom:7px;}
...
.greet-spark{margin-top:8px;font:400 12.5px/1.45 'Inter';color:var(--gold);opacity:.85;text-align:center;max-width:440px;margin-left:auto;margin-right:auto;}
