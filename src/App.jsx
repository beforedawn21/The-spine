...
export default function App(){
  ...
  function buildGameDoc(rawText,gameMode){
    ...
    const __doc='<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
      ...
      +'if(cv){var __cr=cv.getBoundingClientRect();if((cv.width>1&&cv.height>1)||(__cr&&__cr.width>1&&__cr.height>1)){__log("game started OK","#0f0");try{parent.postMessage({__spineGame:true,ok:true},"*");}catch(e){}setTimeout(function(){if(__s)__s.style.display="none";},1600);return;}}'
