...
.spa{--bg:#F7F4EF;--panel:#FFFFFF;--stone:#E8E2D9;--stone-m:#D2CCC3;--stone-l:#F0EDE7;
  ...
  font-family:'Manrope',system-ui,sans-serif;color:var(--ink);background:var(--bg);min-height:100vh;-webkit-font-smoothing:antialiased;}
...
.chats-dd{position:absolute;top:42px;right:0;width:280px;max-height:60vh;overflow-y:auto;background:var(--panel);border:1px solid var(--stone);border-radius:14px;box-shadow:0 14px 40px rgba(31,27,22,.16);z-index:30;padding:8px;}
...
.play-frame{width:100%;height:82vh;max-height:760px;border:none;background:var(--bg);display:block;}
