...
export default function App(){
  ...
  function buildGameDoc(rawText,gameMode){
    ...
    return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
      ...
      +'try{if(document.readyState!=="loading"){setTimeout(function(){try{document.dispatchEvent(new Event("DOMContentLoaded"));}catch(e){}try{window.dispatchEvent(new Event("load"));}catch(e){}},0);}}catch(e){}'
      ...
      +'__log("game did not start (no visible canvas)","#fa0");try{parent.postMessage({__spineGame:true,error:"Game ran but produced no visible canvas. For 2D Phaser use scale:{mode:Phaser.Scale.FIT,autoCenter:Phaser.Scale.CENTER_BOTH,width:800,height:600} (do NOT use Scale.RESIZE or window.innerWidth) and draw something in create(). For 3D Three.js append renderer.domElement to document.body, run a requestAnimationFrame loop calling renderer.render, add a light, and position the camera to see the objects."},"*");}catch(e){}'
