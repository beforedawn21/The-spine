...
export default function App(){
  ...
  function buildGameDoc(rawText,gameMode){
    ...
    // Strip any engine <script src=...> the AI added (we control load order).
    ...
    return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
      ...
      +'<scr'+'ipt src="'+libUrl+'"></scr'+'ipt>'
      +'</head><body>'+bodyInner
      +'<scr'+'ipt>(function(){function go(){try{\n'+inlineJs+'\n}catch(e){document.body.innerHTML="<div style=\\"color:#fff;font-family:sans-serif;padding:20px\\">Game error: "+e.message+"</div>";}}'
      +'function ready(){ if(typeof Phaser!=="undefined"||typeof THREE!=="undefined"){go();}else{setTimeout(ready,60);} }'
      +'if(document.readyState==="complete"){ready();}else{window.addEventListener("load",ready);}})();</scr'+'ipt>'
      +'</body></html>';
  }
  function previewWeb(){
    let doc;
