              ...
              {toolsOpen&&(
                <div className="tools-drawer">
                  <div className="tools-drawer-grid">
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");}}><span className="cc-ic">{"\u2318"}</span><span className="cc-name">Code</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("image");}}><span className="cc-ic">{"\u25a6"}</span><span className="cc-name">Image</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("video");}}><span className="cc-ic">{"\u25ae"}</span><span className="cc-name">Video</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("music");}}><span className="cc-ic">{"\u266a"}</span><span className="cc-name">Music</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("dub");}}><span className="cc-ic">{"\u25cd"}</span><span className="cc-name">Voice</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("game");}}><span className="cc-ic">{"\u2b22"}</span><span className="cc-name">Game</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("blueprint");}}><span className="cc-ic">{"\u229e"}</span><span className="cc-name">Blueprint</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");setPipe("movie");}}><span className="cc-ic">{"\u2756"}</span><span className="cc-name">Movie</span></button>
                    <button className="create-cc" onClick={()=>{setToolsOpen(false);setTab("code");}}><span className="cc-ic">{"\u2192"}</span><span className="cc-name">All tools</span></button>
                  </div>
                </div>
              )}
              <div className="core-input-row">
                <button className="attach-btn icon-only" onClick={()=>setToolsOpen(v=>!v)} disabled={coreBusy} aria-label="Creation tools" title="Creation tools">
