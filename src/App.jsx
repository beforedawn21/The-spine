...
export default function App(){
  ...
  async function doCore(override){
    ...
    const factualLookup=/\b(frame data|stats|statistics|price|cost|score|standings|ranking|release date|weather|temperature|forecast|who (is|won|plays|owns)|when (did|was)|how many|how much|net worth|population of|capital of|ceo of|founded|located|schedule|lineup|roster|box office|record for)\b/i.test(q);
