...
.wordmark{font:600 20px/1 'Instrument Serif';white-space:nowrap;color:var(--ink);display:inline-flex;align-items:center;letter-spacing:.01em;}
...
.greet-h{font-size:21px;color:var(--ink);margin-bottom:5px;}
    ...
    <div className={"spa"+(dark?" dark":"")}>
      ...
      <div className="shell" onTouchStart={onSwipeStart} onTouchEnd={onSwipeEnd}>
        ...
        <nav className="topnav" aria-label="Main navigation">
          <div className="brand">
            <div className="wordmark serif" aria-label="The Spine"><span className="wm-the">THE</span>SP<span className="smark-i" aria-hidden="true"/>NE</div>
          </div>
              ...
              <div className="thread">
                {thread.length===0&&!coreBusy&&(
                  ...
                  <div className="greet">
                    ...
                    <div className="greet-h serif">{returning?(account&&account.name?("Welcome back, "+account.name.split(" ")[0]+"."):"Welcome back."):"Hello - I'm The Spine."}</div>
