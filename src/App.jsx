...
export default function App(){
  ...
  async function doCore(){
    ...
    // do the lookup FIRST, then fold the findings into ONE clean answer. The user never sees a "can't" then a "can".
    ...
    const needsLookup=live&&(answerSignalsGap(answer)||timeSensitive)&&settings.killSearch!==true;
    if(needsLookup){
