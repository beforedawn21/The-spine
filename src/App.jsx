...
.wordmark{font:800 20px/1 'Manrope';white-space:nowrap;color:var(--ink);display:inline-flex;align-items:center;letter-spacing:-.01em;}
...
.greet-h{font:800 23px/1.15 'Manrope';letter-spacing:-.5px;color:var(--ink);margin-bottom:5px;}
      ...
      {playingGame&&(
        <div className="modal-back" onClick={()=>setPlayingGame(null)}>
          <div className="modal play-modal" onClick={e=>e.stopPropagation()}>
            ...
            <iframe title="play" className="play-frame" sandbox="allow-scripts allow-pointer-lock allow-forms allow-modals" allow="camera; microphone; geolocation; accelerometer; gyroscope; magnetometer; clipboard-write" srcDoc={playingGame.doc}/>
          </div>
        </div>
      )}
      {signInOpen&&(
