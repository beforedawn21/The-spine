...
export default function App(){
  ...
  async function runPipeline(){
    ...
    if(p.key==="blueprint"&&res.live&&settings.killImages!==true){
      ...
      const drawPrompt="A clean, labeled technical blueprint / engineering drawing of: "+pipeIn.trim()+". White lines on blueprint-blue background, orthographic views, dimension lines and measurement callouts, schematic and precise, drafting style.";
      const imgSrc=await pullImage(drawPrompt,false);
