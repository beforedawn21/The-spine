...
export default function App(){
  ...
  async function doCore(){
    ...
    // Signed-in users spend credits per question (free/anon users are capped above instead).
    const questionCost=account?(settings.coreCostPaid||CORE_COST_PAID)*(ensembleMode?CORE_COST_ENSEMBLE_MULT:1):0;
    if(account&&questionCost>balance){
