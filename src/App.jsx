...
export default function App(){
  ...
  async function doCore(){
    ...
    // SEARCH INTELLIGENCE: look up when the AI admits a gap, OR when the question is clearly time-sensitive
    // (latest/current/today/recent/this year), since training data goes stale. Still gated by kill switch.
    const timeSensitive=/\b(latest|current|today|tonight|right now|this (week|month|year)|recent|newest|as of|up to date|currently|2025|2026)\b/i.test(q);
    if(live&&(answerSignalsGap(answer)||timeSensitive)&&settings.killSearch!==true){
