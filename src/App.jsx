    ...
    try{
      ...
      img.onload=()=>{
        try{
          ...
          if(w<=me&&h<=me){ resolve(dataUrl); return; } // already small enough
          if(w>=h){ h=Math.round(h*(me/w)); w=me; } else { w=Math.round(w*(me/h)); h=me; }
...
export default function App(){
  ...
  async function doCore(){
    ...
    if(att&&att.kind==="image"&&att.dataUrl&&att.dataUrl.indexOf(",")!==-1){
      const mm=(att.dataUrl.match(/^data:([^;]+);base64,/)||[])[1]||"image/jpeg";
