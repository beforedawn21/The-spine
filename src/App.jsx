...
function answerSignalsGap(text){
  ...
  async function tryLookup(q){
    ...
    if(parts.length>1){
      ...
      for(const part of parts){
        try{
          ...
          if(d.notConnected) return {debug:"NO KEY - Tavily key not found in Vercel"};
          let ans=d.answer||"";
    ...
    try{
      ...
      if(data.answer) return {answer:data.answer,sources:srcs};
      ...
      if(data.results&&data.results.length){
        ...
        if(ctx.trim()) return {answer:ctx,sources:srcs};
      }
