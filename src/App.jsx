...
export default function App(){
  ...
  async function runPipeline(){
    ...
    if(p.key==="game"){
      ...
      if(gameMode==="3d"){
        brief="You are Spine's 3D game engine. Build a complete, playable 3D game using Three.js. Assume THREE is already loaded as a global (do NOT add a script tag or import for it - just use `THREE`). Return ONE complete HTML5/JavaScript block: a full <body> with a canvas/renderer, a real game loop, lighting, camera, player movement, win/lose, score, and clear on-screen controls. Let the player define or see the controls (WASD/arrows/mouse, and gamepad via the Gamepad API where it fits). Make it genuinely playable immediately - not a static scene. Include a short title/instructions overlay. Keep it self-contained in one file. IMPORTANT: keep the code COMPACT and COMPLETE - a focused, finished game is far better than an ambitious one that runs long. Do not exceed what you can fully finish; always close every function and return complete, runnable code.";
      }else{
        brief="You are Spine's 2D game engine. Build a complete, playable 2D game using Phaser 3. Assume Phaser is already loaded as a global (do NOT add a script tag or import for it - just use `Phaser`). Return ONE complete HTML5/JavaScript block: a full Phaser.Game config with preload/create/update, real sprites or graphics, physics, working controls, score, and win/lose. Support keyboard AND touch controls (and gamepad via Phaser's input where it fits) so it plays on phone or PC. Add a short title/instructions overlay. Make it actually fun and playable immediately. Keep it self-contained in one file. IMPORTANT: keep the code COMPACT and COMPLETE - a focused, finished game is far better than an ambitious one that runs long. Do not exceed what you can fully finish; always close every function and return complete, runnable code.";
      }
    }
