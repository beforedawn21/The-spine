...
.create-strip{margin-top:22px;}
.greet-spark{margin-top:12px;font:400 13px/1.5 'Inter';color:var(--gold);opacity:.85;}
...
export default function App(){
  ...
  const NAV_ALL=[["core","Core","spinal cord"],["code","Create","nervous center"],["vault","Vault","memory cortex"]];
          ...
          <div className="g2">
            <div className="panel" style={{gridColumn:"1 / -1"}}>
              ...
              <div style={{display:"flex",gap:8,marginTop:6,flexWrap:"wrap",marginBottom:14}}>
                ...
                <button className="run-btn ghost" style={{width:"auto",padding:"0 16px",marginTop:0}} onClick={()=>setTab("marketplace")}>Market</button>
