...
export default function App(){
  ...
  function buildGameDoc(rawText,gameMode){
    ...
    return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
      ...
      +'function __fail(msg){__log(msg,"#f55");}'
      +'function __runGame(){__log("engine loaded. running game...","#0f0");try{'+inlineJs+'\n__log("game started OK","#0f0");setTimeout(function(){if(__s)__s.style.display="none";},2500);}catch(e){__fail("Game error: "+e.message);}}'
