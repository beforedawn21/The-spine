...
export default function App(){
  ...
  function buildGameDoc(rawText,gameMode){
    ...
    const __doc='<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
      ...
      +'<div id="__boot">Starting your game...<small>Give it a moment, then tap the screen to begin</small></div>'
      ...
      +'if(__sized&&!__drew&&__wd>=10){__log("canvas is blank","#fa0");try{parent.postMessage({__spineGame:true,error:"The game created a canvas but it is blank (nothing was drawn). Make sure something is actually drawn and rendered: for 2D Phaser draw shapes/text in create() with visible colors on a non-black background; for 3D Three.js add a light, position the camera to see the objects, and run a requestAnimationFrame loop that calls renderer.render(scene,camera) every frame."},"*");}catch(e){}return;}}'
